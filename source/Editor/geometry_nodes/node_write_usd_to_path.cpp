...
NODE_DEF_OPEN_SCOPE
NODE_DECLARATION_FUNCTION(write_usd_to_path)
{
...
NODE_EXECUTION_FUNCTION(write_usd_to_path)
{
...
NODE_DECLARATION_REQUIRED(write_usd_to_path);

NODE_DECLARATION_UI(write_usd_to_path);
