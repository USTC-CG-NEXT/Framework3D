...
#     random_seeds = torch.randint(0, 1, (1, 1), device="cuda", dtype=torch.int32)
...
#     rays = torch.zeros(1, 1, 11, device="cuda", dtype=torch.float32)
#     pixel_targets = torch.zeros(1, 1, 2, device="cuda", dtype=torch.int32)
