...
if __name__ == "__main__":
    ...
    parser.add_argument("output_directory", nargs='?', default=os.getcwd(), help="The directory where the header file will be saved (default: current working directory).")
    parser.add_argument("--output_file", default="api.h", help="The name of the output header file (default: api.h).")
